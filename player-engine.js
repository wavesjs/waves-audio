...
var PlayerEngine = (function(super$0){var DP$0 = Object.defineProperty;var MIXIN$0 = function(t,s){for(var p in s){if(s.hasOwnProperty(p)){DP$0(t,p,Object.getOwnPropertyDescriptor(s,p));}}return t};MIXIN$0(PlayerEngine, super$0);
  ...
  PlayerEngine.prototype.__start = function(time, position, speed) {
    if (this.buffer) {
  ...
  PlayerEngine.prototype.__halt = function(time) {
  ...
  PlayerEngine.prototype.syncSpeed = function(time, position, speed) {var seek = arguments[3];if(seek === void 0)seek = false;
...
;return PlayerEngine;})(TimeEngine);
