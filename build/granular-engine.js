!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var n;"undefined"!=typeof window?n=window:"undefined"!=typeof global?n=global:"undefined"!=typeof self&&(n=self),n.createGranularEngine=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
/**
...
var makeSchedulable = _dereq_("makeSchedulable");
...
},{"makeSchedulable":11}],2:[function(_dereq_,module,exports){
/*!
...
/**
 * @fileoverview WAVE audio library element: schedulable objects mixin.
 * @author Karim.Barkati@ircam.fr, Norbert.Schnell@ircam.fr, Victor.Saiz@ircam.fr
 * @version 3.3.1
 */

var nodeUuid = _dereq_("node-uuid");
var propertyCheck = _dereq_("property-check");
...
var makeSchedulable = function makeSchedulable(object) {
  ...
  /**
   * List of required properties for an object to be schedulable.
   * @private
   */
   ...
   * @private
   */
  var schedulableMixinProperties = {
    isSchedulable: {
      value: true
    },
    scheduler: {
    ...
    setScheduler: {
      ...
      value: function(scheduler) {
        if (scheduler) {
          ...
          this.schedulingID = nodeUuid.v4();
          return this; // for chainability
        } else {
          throw new ReferenceError("setScheduler(): no scheduler");
        }
      }
    },
    reschedule: {
      enumerable: true,
      value: function(time) {
        this.scheduler.updateNextTime(this, time);
      }
    },
  };
  ...
  if (object) {
    ...
    Object.defineProperties(object, schedulableMixinProperties);
    var optName = object.name ? '\"' + object.name + '\"' : "";
    console.log("makeSchedulable():", optName); // , object);
  } else {
    throw new ReferenceError("makeSchedulable(): no object");
  }
};
...
// CommonJS function export
module.exports = makeSchedulable;
},{"node-uuid":12,"property-check":13}],12:[function(_dereq_,module,exports){
(function (Buffer){
//     uuid.js
//
...
},{"buffer":2,"crypto":6}],13:[function(_dereq_,module,exports){
/** 
 * @fileOverview
 * WAVE audio library module for property checking.
 * @author Karim.Barkati@ircam.fr, Victor.Saiz@ircam.fr
 * @version 0.1.0
 */
...
var propertyCheck = function propertyCheck(object, properties) {
  ...
  function checkProperties(element, index, array) {
    if (object.hasOwnProperty(element)) {
      ...
      throw new Error("propertyCheck(): property", element, "is required");
    }
  }
