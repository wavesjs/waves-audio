...
// create GUI elements
new wavesBasicControllers.Title("Metronome in Scheduler", '#container');
...
new wavesBasicControllers.Slider("Tempo", 30, 240, 1, 90, "bpm", '', '#container', function(value) {
  scheduledMetronome.period = 60 / value;
});

new wavesBasicControllers.Title("Metronome with Play Control", '#container');
...
var speedSlider = new wavesBasicControllers.Slider("Speed", 0, 2, 0.01, 1, "", '', '#container', function(value) {
...
new wavesBasicControllers.Slider("Phase", 0, 1, 0.01, 0, "", '', '#container', function(value) {
